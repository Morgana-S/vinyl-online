...
| Authorised User Link Navigation | Log the user in, go through all pages accessible to the user and ensure they lead to the correct locations. | All links work correctly. |Working as intended | 
| Footer Links - Unauthorised Users | Clicking the links in the footer as a guest user take the user through to the appropriate pages. Contact Us, Terms and Conditions, Return Policy, Github Link, and Privacy Policy should also open in a new page.  | All links work correctly. |Working as intended. |
| Footer Links - Authorised users | Clicking the links in the footer a signed in user takes the user through to the appropriate pages. Contact Us, Terms and Conditions, Return Policy, Github Link, and Privacy Policy should also open in a new page.  | All links work correctly. |Working as intended. |
