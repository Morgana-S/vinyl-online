...
A great approach to a marketing strategy would be to center the business as one that connects fans with their music - as such, newsletter signups could be a pathway to concert tickets for fans, with the possibility of VIP tickets, giveaways, and similar actions to promote interest in the site. Rather than focusing on a wide volume of consumers across the board, building up a core customer base that enjoys using the site because the business cares about music and its customers would be a better way of doing things. Emphasizing that quality over quantity approach would likely maintain a more stable business model.

A two-way approach would also work well; advertising at concerts, setting up booths with records from featured bands would also be a good way to promote sales. Having a physical presence that directs people to the website, and then a digital presence that directs people to the physical presence (either a brick and mortar store or the concert booths) would also create a positive feedback loop. Being in contact with smaller bands and promoting their work also has the potential to lead to greater success as an investment; if a small band becomes popular and famous and benefits from Vinyl Online's investment and support, it is likely that Vinyl Online will be able to negotiate favourable deals with the band later down the line. Practices that promote the spread and enjoyment of music can be both profitable and rewarding in this manner.
